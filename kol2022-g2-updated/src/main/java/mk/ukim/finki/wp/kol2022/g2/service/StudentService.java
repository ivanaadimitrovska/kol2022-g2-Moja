...
public interface StudentService {
     ...
     * @throws mk.ukim.finki.wp.kol2022.g2.model.exceptions.InvalidCourseIdException when there is no category with the given id
     */
     ...
     * @throws InvalidStudentIdException when there is no entity with the given id
     * @throws mk.ukim.finki.wp.kol2022.g2.model.exceptions.InvalidCourseIdException when there is no course with the given id
     */
